...
mixin _$AppState {
  UIStatus get status =>
      throw _privateConstructorUsedError; //  @Default(AppConfig.defaultLocale) String locale,
...
class _$AppStateImpl implements _AppState {
  const _$AppStateImpl(
      {this.status = const UIInitial(), this.isDarkMode = false});
...
//  @Default(AppConfig.defaultLocale) String locale,
  ...
  @override
  String toString() {
    return 'AppState(status: $status, isDarkMode: $isDarkMode)';
  }
...
abstract class _AppState implements AppState {
  const factory _AppState({final UIStatus status, final bool isDarkMode}) =
      _$AppStateImpl;

  @override
  UIStatus get status; //  @Default(AppConfig.defaultLocale) String locale,
  @override
  bool get isDarkMode;
