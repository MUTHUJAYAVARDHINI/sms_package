...
class _LoginApiClient implements LoginApiClient {
  ...
  @override
  Future<UserLoginResponse> UserLoginVerification(String body) async {
  ...
  @override
  Future<UserLoginResponse> SendPassWord(String body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
  ...
  Future<ForgotPasswordResponse> ForgotPassword(String body) async {
    ...
    final _options = _setStreamType<ForgotPasswordResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'banking/sms/usermaster/forgetpassword',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
